<template>
  <!-- Sandra har stylet siden i "normalt" kodning og Mads har derefter tilpasset det til Vue og gjort det responsivt -->
      ...
      <div class="table">
        ...
        <div class="tabletable">
          ...
          <table>
            ...
            <tr>
              <td>Ydre gearkabel</td>
              <td>Kr. 220</td>
            </tr>
            <tr>
              <td>Ydre bremsekabel</td>
              <td>Kr. 220</td>
            </tr>
            <tr>
              <td>Krankbox</td>
            ...
            <tr>
              <td>Gearskiftegreb</td>
              <td>Kr. 450</td>
            </tr>
            <tr>
              <td>Bremsegreb 1 stk.</td>
              <td>Kr. 250</td>
            </tr>
            <tr>
              <td>Pedaler</td>
